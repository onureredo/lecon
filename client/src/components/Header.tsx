...
export const Header: React.FC = () => {
  ...
  return (
    <>
      <header className='sticky top-0 z-50 flex justify-between items-center py-2 px-6 bg-rouge backdrop-blur-sm text-white border-b-4 border-night-shade sm:hidden xxs:w-full'>
        <div id='sidebar'>
          <button
